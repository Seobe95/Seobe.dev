...
---
![나만의 블로그 만들기 썸네일](/thumbnail/blog.png "포스트 대표 이미지")
*해당 썸네일은 oneook님의 [썸네일 메이커](https://wonkooklee.github.io/thumbnail_maker/)를 통해 제작되었습니다.*
___
...
## 다크모드
다크모드를 구현할 때, 다양한 선택지가 있었습니다. 제가 사용하는 __Styled-Components__의 __ThemeProvider__와, 제가 즐겨 찾아보는 velog의 운영자이신
